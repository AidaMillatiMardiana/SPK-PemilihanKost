...
<body>
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" href="#">SPK Kombinasi Metode Topsis Dan Smart Dalam Penentuan Kost Terbaik Daerah Kota Malang</a>
      </div>
  ...
  <div class="col-sm-2">
    <ul class="nav nav-pills nav-stacked">
      ...
      <li <?php echo $active4 ?>><a href="?a=hasiltopsis&k=nilai_matriks">Hasil Perhitungan</a></li>
    </ul>
  </div>
  <!-- /TAB KIRI -->
